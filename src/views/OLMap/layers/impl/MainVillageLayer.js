...
class MainVillageLayer extends BaseVectorLayer {
  ...
  async load(params) {
    ...
    this.adcdFeatures[adcd].forEach((feature) => {
      ...
      const fadcd = feature.get('admin_div_code')
      if (fadcd === '330182001') {
      ...
      } else if (fadcd === '330182105') {
        feature.set('properties', {
          score: '98',
          level: '幸福',
          adName: feature.get('admin_div_name')
        })
      } else if (fadcd === '330182109') {
        feature.set('properties', {
          score: '98',
          level: '一般',
          adName: feature.get('admin_div_name')
        })
      } else if (fadcd === '330182113') {
        feature.set('properties', {
          score: '98',
          level: '不幸福',
          adName: feature.get('admin_div_name')
