...
<template>
  <div class="video">
    <div class="header_title">{{ vmName ?? "test" }}</div>
...
//   getHttp(`/monitor/controlVideo?code=${vmCode.value}`, {
//     command: type,
//     speed: 15,
//   })
//     .then((res) => {
...
// 播
// const play = (Code) => {
//   getHttp("/monitor/queryVideoUrlList", { codeList: Code })
//     .then((data) => {
//       return data;
//     })
//     .then(({ message }) => {
