    ...
    <ul class="totle_ul">
      <li>
        ...
        <span class="item-value" style="color: #fff">
          {{ eventGradeInfo?.unitEventNumTotal || 0 }}
        </span>
        <span>个</span>
      </li>
      <li>
        ...
        <span class="item-value" style="color: #e35f5f">
          {{ eventGradeInfo?.unitCompletedNumTotal || 0 }}
        </span>
        <span>个</span>
      </li>
      <li>
        ...
        <span class="item-value" style="color: #ffb401">
          {{ eventGradeInfo?.unitNoCompletedNumTotal || 0 }}
        </span>
        <span>个</span>
      </li>
      <li>
        ...
        <span class="item-value" style="color: #0adbe0">
          {{ eventGradeInfo?.unitCompletedRateTotal || 0 }}
        </span>
        <span>%</span>
      </li>
    </ul>
...
import {
  ...
  getEventStatDistributePersons,
  getEventStatDistribute,
} from "@/apis/home.js";
...
function getTotalData() {
  getEventDistributeInfo(params).then((res) => {
...
function getLeftData() {
  ...
  getEventStatDistributePersons(params).then((res) => {
    ...
    unitLists.value = res.eventResponsibleUnitList;
  });
}
getLeftData();
// 事件派发结果
const eventGradeList = ref([]);

function getEventGradeList() {
  getEventStatDistribute(params).then((res) => {
    if (!res?.eventGradeList) {
      return;
    }
    eventGradeList.value = res.eventGradeList;
  });
}
getEventGradeList();
